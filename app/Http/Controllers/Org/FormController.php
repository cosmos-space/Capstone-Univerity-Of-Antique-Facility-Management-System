...
{ 
    ...
    public function createFacilities()
    {
        ...
        // GSU-managed facilities + this org's own facilities
    ...
    public function storeFacilities(Request $request)
    {
        ...
        $payload = [
            ...
            'requester_unit'  => $user->organization_name,
        ...
        foreach (User::where('role', 'admin')->get() as $admin) {
            Notification::create([
                ...
                'title'   => 'New facilities request from organization',
                'message' => $user->organization_name . ' submitted a new utilization request.',
                'data'    => ['submission_id' => FormSubmission::where('requester_id', $user->id)->latest()->first()->id ?? null],
            ]);
        }
