...
<div class="fms-card">
    <div class="fms-page-header">
        ...
        <a href="{{ route('org.requests.facilities.create') }}" class="fms-btn-primary">New Request</a>
    </div>
                ...
                <tbody>
                    @foreach ($submissions as $submission)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('org.requests.facilities.show', $submission) }}" class="fms-link">View</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    @else
        <div class="py-12 text-center">
            ...
            <a href="{{ route('org.requests.facilities.create') }}" class="fms-btn-primary">Submit Your First Request</a>
        </div>
    @endif
</div>
@endsection
