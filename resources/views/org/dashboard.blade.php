...
@section('content')
    <h1 class="text-2xl font-semibold mb-4">Organization Dashboard</h1>
    <p class="text-sm text-gray-700">
        Welcome to the Organization Staff Dashboard. Here you can manage facility requests for your organization.
    </p>
