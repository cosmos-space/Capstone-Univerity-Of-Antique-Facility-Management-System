...
ROLE = "college_staff"
SECRET = os.getenv('FMS_COLLEGE_SECRET', 'UA-COLLEGE-2025')
...
def main():
    ...
    print("COLLEGE STAFF PORTAL - Authorized Personnel Only")
    print()

    # Use getpass so the key isn't shown as you type
    key = getpass.getpass("Enter college staff access key: ")
    ...
    print("Access granted. Opening college staff portal...")
    webbrowser.open(LOGIN_URL)
    print("College staff portal opened in your default browser.")
    input("Press Enter to close...")
    sys.exit(0)
