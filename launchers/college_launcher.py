"""
UA Facility Management System - College Staff Portal Launcher
    ...
    def open_portal(self):
        ...
        try:
            ...
            webview.create_window(
                title="UA Facility Management - College Staff Portal",
                url=LOGIN_URL,
                width=1200,
                height=800,
                resizable=True,
...
def create_login_html():
    ...
    <body>
        <div class="login-container">
            ...
            <div class="role-badge">College Staff Portal</div>

            <label for="keyInput">College staff access key</label>
